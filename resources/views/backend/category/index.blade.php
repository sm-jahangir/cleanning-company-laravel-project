                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <p>All Categorys Here, Category Base Post Cont</p>
                            </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{ route('admin.category.create') }}"><span>Add
                                                                    Category</span></a></li>
                                                        <li><a href="#"><span>Add Team</span></a></li>
                                                        <li><a href="#"><span>Import Category</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <div class="form-inline flex-nowrap gx-3">
                                            <div class="form-wrap w-150px">
                                                <select class="form-select form-select-sm" data-search="off"
                                                    ...
                                                    <option value="suspend">Suspend Category</option>
                                                </select>
                                            </div>
                                            <div class="btn-wrap">
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col"><span class="sub-text">Category Name</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Category Slug</span>
                                        </div>
