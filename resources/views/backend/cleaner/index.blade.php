                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Cleaner Lists</h3>
                            <div class="nk-block-des text-soft">
                                <p>All Cleaners Here, Cleaner Base Post Cont</p>
                            </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{ route('admin.cleaner.create') }}"><span>Add
                                                                    cleaner</span></a></li>
                                                        <li><a href="#"><span>Add Team</span></a></li>
                                                        <li><a href="#"><span>Import cleaner</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <div class="form-inline flex-nowrap gx-3">
                                            <div class="form-wrap w-150px">
                                                <select class="form-select form-select-sm" data-search="off"
                                                    ...
                                                    <option value="suspend">Suspend cleaner</option>
                                                </select>
                                            </div>
                                            <div class="btn-wrap">
                                    ...
                                    <div class="card-body">
                                        <div class="search-content">
                                            ...
                                            <input type="text" class="form-control border-transparent form-focus-none"
                                                placeholder="Search by cleaner or email">
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col"><span class="sub-text">Cleaner Name</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Cleaner Slug</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-lg">
                                            <span>{{ $cleaner->slug }}</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                            <span>{{ $cleaner->updated_at }}</span>
                                        </div>
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin.cleaner.edit',$cleaner->id) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <em class="icon ni ni-edit-alt-fill"></em>
                                                    </a>
                                                </li>
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{ route('admin.cleaner.destroy',$cleaner->id) }}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Delete" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $cleaner->id }}').submit();">
                                                        <em class="icon ni ni-cross-fill-c"></em>
                                                    </a>
                                                </li>
                                                <form id="delete-form-{{ $cleaner->id }}" action="{{ route('admin.cleaner.destroy',$cleaner->id) }}" method="POST" style="display: none;">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
                                                <li>
