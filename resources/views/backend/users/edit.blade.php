                                        ...
                                        <div class="row gy-4">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" name="name" class="form-control" id="default-03" value="{{ $user->name }}" placeholder="User Name Here">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="email" name="email" class="form-control" id="default-04" value="{{ $user->email }}" placeholder="User Email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="password" class="form-control"
                                                            id="fw-re-password" name="password_confirmation">
                                                    </div>
                                                </div>
                                            </div>
