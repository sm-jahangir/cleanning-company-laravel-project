                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <form method="POST" action="{{ route('admin.roles.update', $role->id) }}" class="">
                                    @method('PUT')
                                    @csrf
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" {{$role->hasPermissionTo($permission->name) ? 'checked' : ''}} name="permissions[]" class="custom-control-input" value="{{$permission->name}}" id="side-off-{{$permission->id}}">
