                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Appointment Lists</h3>
                            <div class="nk-block-des text-soft">
                                <p>All Appointments Here, Appointment Base Post Cont</p>
                            </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{ route('admin.tags.create') }}"><span>Add
                                                                    tag</span></a></li>
                                                        <li><a href="#"><span>Add Team</span></a></li>
                                                        <li><a href="#"><span>Import tag</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <div class="form-inline flex-nowrap gx-3">
                                            <div class="form-wrap w-150px">
                                                <select class="form-select form-select-sm" data-search="off"
                                                    ...
                                                    <option value="suspend">Suspend tag</option>
                                                </select>
                                            </div>
                                            <div class="btn-wrap">
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col"><span class="sub-text">Appointment Name</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Appointment Phone</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Appointment Service</span></div>
                                        <div class="nk-tb-col tb-col-mb"><span class="sub-text">Appoint Cleaner</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-lg">
                                            <span>{{ $appointment->cleaner->name }}</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <a href="" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Delete" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $appointment->id }}').submit();">
                                                        <em class="icon ni ni-cross-fill-c"></em>
                                                    </a>
                                                </li>
                                                <form id="delete-form-{{ $appointment->id }}" action="" method="POST" style="display: none;">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
                                            </ul>
